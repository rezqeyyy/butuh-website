...
export default function WebsiteDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-6 mx-auto my-16">
      <div
        className={`min-h-5 mx-auto bg-white dark:bg-gray-900 rounded-3xl shadow-md p-6 bg-linear-to-br ${detailWebsite?.color}`}
      >
        <div
          className={`h-40 w-full bg-linear-to-br ${detailWebsite.color} relative p-5 flex flex-col justify-end overflow-hidden`}
        >
