  ...
  return (
    <>
      ...
      <nav className="hidden md:flex fixed top-0 w-full bg-white dark:bg-[#0a0a0a] border-b border-gray-100 dark:border-zinc-800 z-50 px-10 py-3.5 justify-between items-center transition-colors duration-300">
        ...
        {/* Kanan: Menu Utama, Theme Toggle & Auth */}
        <div className="flex items-center gap-4">
          
          {/* Menu Utama pindah ke sini */}
          ...
          <button 
            onClick={toggleTheme} 
            className="w-10 h-10 rounded-full bg-gray-50 dark:bg-zinc-900 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-zinc-800 transition-all border border-gray-100 dark:border-zinc-800"
            title="Ganti Tema"
          >
          ...
          {user ? (
            <div className="relative" ref={dropdownRef}>
              <button 
                ...
                className="flex items-center gap-2 p-1 pr-3 rounded-full border border-gray-200 dark:border-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-900 transition-all bg-white dark:bg-[#0a0a0a]"
              >
                ...
                <div className="absolute right-0 mt-3 w-60 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-2xl shadow-xl overflow-hidden animate-in slide-in-from-top-2 fade-in">
                  ...
                  <div className="p-2">
                    <Link 
                      ...
                      className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 transition-all"
                    >
                      <Settings size={16} /> Pengaturan Akun
                    </Link>
                    <button 
                      onClick={handleLogout}
                      className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-all mt-1"
                    >
            ...
            <Link 
              href="/login"
              className="flex items-center gap-2 bg-[#1a56db] hover:bg-blue-700 text-white px-6 py-2.5 rounded-full font-semibold text-[15px] transition-all"
            >
